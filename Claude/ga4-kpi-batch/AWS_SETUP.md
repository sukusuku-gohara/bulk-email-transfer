...
### 4.1 GOOGLE_CREDENTIALS_JSON の設定方法

**重要:** JSON 文字列は **1行** である必要があります。

1. sa-key.json の内容をコピー
2. オンラインの [JSON formatter](https://jsonformatter.org/) で最小化（minify）
3. コピーして、Lambda の環境変数に貼り付け

例：
```json
{"type":"service_account","project_id":"blockchaingameinfo-487515","private_key_id":"...","private_key":"-----BEGIN PRIVATE KEY-----\n...\n-----END PRIVATE KEY-----\n","client_email":"bcgi-287@blockchaingameinfo-487515.iam.gserviceaccount.com",...}
```
